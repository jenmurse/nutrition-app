...
const MealPlansPage = () => {
  ...
  const handleShareList = async () => {
    ...
    const SHARE_CAT_ORDER = ['Produce','Meat & Seafood','Dairy & Eggs','Grains & Bread','Pasta & Rice','Baking','Nuts & Seeds','Spices & Seasonings','Condiments & Sauces','Oils & Fats','Frozen','Canned & Jarred','Beverages','Snacks'];
          ...
          <div className="mob-sheet pl-shop-sheet" role="dialog" aria-modal="true" aria-label="Shopping list" style={{ display: 'flex', flexDirection: 'column', overflowY: 'hidden' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: '4px 20px' }}>
              {shopLoading ? (
                ...
                const CATEGORY_ORDER = ['Produce','Meat & Seafood','Dairy & Eggs','Grains & Bread','Pasta & Rice','Baking','Nuts & Seeds','Spices & Seasonings','Condiments & Sauces','Oils & Fats','Frozen','Canned & Jarred','Beverages','Snacks'];
