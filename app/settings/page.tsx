        ...
        {JUMP_SECTIONS.map((s, i) => (
          <button
            ...
            className={`flex items-baseline gap-[10px] font-mono text-[9px] tracking-[0.1em] uppercase py-[8px] border-0 bg-transparent cursor-pointer transition-colors text-left ${
              ...
              activeSection === s.id ? 'text-[var(--fg)]' : 'text-[var(--muted)] hover:text-[var(--primary)]'
            }`}
            style={i === 0 ? { paddingTop: 0 } : undefined}
            aria-label={`Jump to ${s.label}`}
          >
            <span className={`font-serif text-[9px] font-bold min-w-[16px] transition-colors ${
              activeSection === s.id ? 'text-[var(--primary)]' : 'text-[var(--rule)]'
            }`}>{s.n}</span>
            {s.label}
          </button>
        ))}
          ...
          <div id="set-sec-mcp" style={{ padding: '56px 0' }}>
            ...
            <div className="flex flex-col gap-[48px]">
              ...
              <div>
                ...
                {newMcpToken && (
                  <div>
                    <div className="font-mono text-[9px] uppercase tracking-[0.08em] text-[var(--primary)] mb-[8px]">
                      Copy this token now — it won&apos;t be shown again
                    </div>
                    <div className="flex items-center gap-[10px] bg-[var(--bg-2)] border border-[var(--primary)] px-[16px] py-[12px]">
                      <code className="font-mono text-[11px] text-[var(--fg)] break-all flex-1">{newMcpToken}</code>
                      <button
                        onClick={handleCopyMcpToken}
                        className="font-mono text-[9px] uppercase tracking-[0.1em] text-[var(--primary)] hover:opacity-70 bg-transparent border-0 cursor-pointer transition-opacity shrink-0"
              ...
              <div>
                ...
                <div className="bg-[var(--bg-2)] px-[20px] py-[16px] relative overflow-x-auto">
                  ...
                  <button
                    ...
                    className="text-[var(--primary)] bg-transparent border-0 cursor-pointer absolute top-[8px] right-[12px] hover:opacity-70 transition-opacity"
                ...
                {importFile && (
                  <div className="flex items-center gap-3 mt-3">
                    <button
                      ...
                      className="px-4 py-[9px] font-mono text-[9px] uppercase tracking-[0.1em] bg-[var(--primary)] text-white border-0 cursor-pointer disabled:opacity-40 hover:opacity-90 transition-opacity"
                ...
                {importResult && (
                  <div
                    className={`mt-4 px-4 py-3 font-sans text-[13px] border ${
                      importResult.ok
                        ? 'border-[var(--primary)] text-[var(--primary)] bg-[var(--bg-subtle)]'
