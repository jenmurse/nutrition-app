    ...
    <div ref={setNodeRef} style={style} {...attributes}>
      ...
      <div className="ing-row flex items-start gap-[10px] transition" style={{ padding: "8px 0" }}>
        ...
        <div className="ing-main relative" style={{ flex: 1 }}>
          <input type="text"
            className={`ing-name ed-input ${!selectedIngredient && row.nameGuess ? '!border-[var(--err)] !text-[var(--err)]' : ''}`}
            ...
            <div className="ing-library-warn" style={{ padding: "2px 0" }}>
              <div className="flex items-center gap-[8px]" style={{ paddingLeft: 10, borderLeft: "2px solid var(--err)", marginTop: 2 }}>
                ...
                <button type="button"
                  ...
                  className="font-mono bg-transparent border-0 p-0 cursor-pointer hover:opacity-70 transition-opacity"
                  style={{ fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--fg)", textDecoration: "underline", textUnderlineOffset: "3px" }}>
                  Add to pantry
                </button>
              </div>
            </div>
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        clientCache.invalidate('/api/recipes?slim=true');
  ...
  return (
    ...
    <div>
      ...
      <div id="rf-sec-method" style={{ marginTop: 64 }}>
        <div className="flex items-baseline gap-3 mb-8">
          <span className="font-mono text-[13px] font-semibold text-[var(--rule)]">04</span>
      ...
      <div id="rf-sec-nutrition" style={{ marginTop: 64 }}>
        <div className="flex items-baseline gap-3 mb-8">
          <span className="font-mono text-[13px] font-semibold text-[var(--rule)]">05</span>
