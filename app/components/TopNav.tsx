...
export default function TopNav() {
  ...
  if (pathname === "/" || pathname === "/login" || pathname === "/preview" || pathname === "/onboarding" || pathname === "/landing" || pathname === "/waitlist" || pathname === "/waitlist-success" || pathname === "/invite" || pathname === "/privacy" || pathname?.startsWith("/admin")) return null;
  ...
  return (
    <nav
      className="top-nav flex items-center h-[var(--nav-h)] bg-[var(--bg)] px-[40px] shrink-0 relative z-10 border-b border-[var(--rule)]"
      role="navigation"
