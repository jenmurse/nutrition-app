  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <button
          onClick={handleParse}
          className="w-full px-4 py-2 bg-[var(--accent-btn)] text-[var(--accent-fg)] hover:opacity-90 font-mono text-[9px] uppercase tracking-[0.1em] transition-colors"
        >
          Parse & Preview
        </button>
      </div>
          ...
          <div className="bg-[var(--bg)] border border-[var(--rule)] max-w-6xl w-full max-h-[90vh] flex flex-col animate-fade-in">
            ...
            <div className="flex gap-3 px-5 py-4 border-t border-[var(--rule)]">
              <button
                ...
                disabled={loading}
                className="flex-1 px-4 py-2 bg-[var(--accent-btn)] text-[var(--accent-fg)] hover:opacity-90 disabled:opacity-50 font-mono text-[9px] uppercase tracking-[0.1em] transition-colors"
              >
