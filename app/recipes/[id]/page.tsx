    ...
    <div className="h-full relative">
      ...
      <div id="rd-scroll-container" className="h-full overflow-y-auto animate-page-enter">
          ...
          <div className="rd-mob-header">
            ...
            {recipe && <span className="rd-mob-title">{recipe.name}</span>}
          </div>
              ...
              <div className="font-mono text-[9px] tracking-[0.14em] uppercase text-[var(--muted)] mb-4">
                ...
                {tags.length > 0 && (
                  <div className="flex gap-[6px] mt-[10px]">
                    {tags.map(tag => (
                      <span key={tag} className="font-mono text-[8px] tracking-[0.1em] uppercase py-[3px] px-[10px] bg-[var(--bg-3)] text-[var(--muted)]">{tag}</span>
                    ))}
                  </div>
                )}
              </div>
                  ...
                  <div className="flex gap-1" role="group" aria-label="Scale recipe">
                    {[1, 2, 4, 6].map(n => (
                      <button key={n} onClick={() => setScale(n)}
                        className={`font-mono text-[8px] tracking-[0.06em] px-[7px] py-[2px] border transition-colors active:scale-[0.97] ${
                          scale === n
