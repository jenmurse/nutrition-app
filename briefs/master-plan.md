...
| May 2 | **Brief 7 shipped — SEO meta updated.** Page title, meta description, OG title, OG description all updated to match current landing copy ("Cook by the gram. Plan by the week."). OG card image unchanged — wordmark regeneration deferred to Step 9. | 7 |
